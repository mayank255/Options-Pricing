...
def bestcall_option_mc(S0, T, r, q, sigma, rho_matrix, K, n_simulations=100000):
    n_assets = len(S0)
...
def simulate_multiple_times_bestcall(N_values, params,repetitions=100):
    ...
    for N in N_values:
        ...
        for rep in range(repetitions):
            option_price= bestcall_option_mc(S0, T, r, q, sigma, rho_matrix, K, n_simulations=N)
